...
- **Clipboard Implementation**: Replaced a buggy clipboard library with a more robust, external command-based approach, fixing an issue where content would not be available for pasting.
...
- **Version Bump**: Project version updated to `0.2.0` to reflect the addition of new features.
